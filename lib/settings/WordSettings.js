...
(function (root, wordSetsFactory) {  // root is usually `window`
	...
	var WordSettings = function ( controller, coreSettings ) {
		...
		*/
		...
		wSets._assignSettingItems = function () {
			...
			nodes.maxCharsInput 				= $menu.find('#__rdly_wpm_input')[0];
			nodes.maxCharsSlider 			= $menu.find('#__rdly_wpm_slider')[0];
