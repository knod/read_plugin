...
(function (root, setupFactory) {  // root is usually `window`
    if ( typeof define === 'function' && define.amd) {  // amd if possible
        ...
        define( ['jquery', '../third-party/franc.js', 'iso-639.json', '@knod/unfluff', '@knod/sbd'], function (jQuery, franc, langCodes, unfluff, sbd) { return (root.Parser = setupFactory(jQuery, franc, langCodes, unfluff, sbd) ); });
    } else if ( typeof module === 'object' && module.exports) {  // Node-ish next
        // Node. Does not work with strict CommonJS, but only CommonJS-like
        // environments that support module.exports, like Node.
        module.exports = setupFactory( require('jquery'), require('../third-party/franc.js'), require('./parse/iso-639.json'), require('@knod/unfluff'), require('@knod/sbd') );
